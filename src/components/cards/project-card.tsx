...
export function ProjectCard({ slug, title, client, heroImage, industry, location }: ProjectCardProps) {
  return (
    <Link
      to={`/projects/${slug}`}
      className="group block bg-white rounded-xl overflow-hidden border border-gray-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
    >
      ...
      <div className="p-5">
        ...
        <span className="inline-flex items-center gap-1 text-teal text-sm font-medium mt-3 group-hover:gap-2 transition-all">
